...
class Test extends State<Index>{
  ...
  var userEmailEdit = TextEditingController(text: preferencesclass.getUserEmail());
        ...
        child: SingleChildScrollView(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Row(
                children: <Widget>[
                  new Checkbox(value: isEmailCheck, onChanged: (bool value){
                    //_isEmailCheck = value;
                    onChanged(value);
                        ...
                        onPressed: () async {
                          ...
                          if(userEmailEdit.text.length == 0){
                            ...
                            if(preferencesclass.getEmailCheck()){
                              preferencesclass.setUserEmail(userEmailEdit.text);
                            }
                            else{
                            ...
                            loginclass.loginFirebase(context, userEmailEdit.text, userpasswordEdit.text);
                          }
                        },
                      ),
                    )
                ...
                children: [
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: new SignInButton(
                        Buttons.Facebook,
                        onPressed: () {loginclass.logInFaceBook();},
                        mini: true,
                      ),
                    )
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: new SignInButton(
                        Buttons.Google,
                        onPressed: () {loginclass.signInGoogle();},
                        mini: true,
                      ),
                    ),
                  ),
